...
-- Defines an object named lab1b_tb_vhd
ENTITY lab1b_tb_vhd IS
END lab1b_tb_vhd;

-- Defines the architecture of lab1b_tb_vhd, which is called "behavior"
...
BEGIN
	...
	uut: LFDetector_behav PORT MAP(
	    -- Each line assigns the signals from lines 53 to 59 to the ports
	    -- declared in lines 44 to 48.
		Fuel3 => Fuel3,
		Fuel2 => Fuel2,
		Fuel1 => Fuel1,
		Fuel0 => Fuel0,
